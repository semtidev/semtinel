...
const _hoisted_162$1 = { key: 8 };
const _hoisted_163$1 = /* @__PURE__ */ createBaseVNode("i", { class: "mdi mdi-plus mdi-18px bg-success" }, null, -1);
const _hoisted_164$1 = { class: "timeline-item" };
const _hoisted_165$1 = { class: "time" };
const _hoisted_166$1 = /* @__PURE__ */ createBaseVNode("i", { class: "far fa-clock" }, null, -1);
const _hoisted_167$1 = {
  key: 0,
  class: "timeline-header timeline-gray-light"
};
        ...
        return openBlock(), createElementBlock(Fragment, { key: idx }, [
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(item, (node, node_idx) => {
            return openBlock(), createElementBlock(Fragment, { key: node_idx }, [
              ...
              node.node_type == "product-add" ? (openBlock(), createElementBlock("div", _hoisted_162$1, [
                _hoisted_163$1,
                createBaseVNode("div", _hoisted_164$1, [
                  createBaseVNode("span", _hoisted_165$1, [
                    _hoisted_166$1,
                    createTextVNode(" " + toDisplayString(node.hour), 1)
                  ]),
                  node.attach_path != null && node.attach_path != "" ? (openBlock(), createElementBlock("h3", _hoisted_167$1, [
                    _hoisted_168,
