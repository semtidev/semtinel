  ...
  #init() {
    ...
    this.element.querySelectorAll("li").forEach((li) => {
      ...
      if (ul) {
        ...
        const parent = li.querySelector(".nav-link");
        parent.addEventListener("click", () => {
          ...
          this.element
            ...
            .forEach(function(pnode) {
              pnode.classList.remove("row-active");
              pnode.classList.remove("nt-li");
              pnode.classList.remove("active");
              pnode.classList.remove("node-selected");
            });
          a.classList.add("nt-li");
          a.classList.add("active");
          a.classList.add("node-selected");
          //a.closest('div').classList.add("row-active");
        });
        
        a.classList.add("is-parent");
        ...
        a.addEventListener("click", () => {
          this.element
            ...
            .forEach((li) => li.classList.remove("active"));
          this.element
            .querySelectorAll("a.nt-li.active")
            .forEach((pnode) => pnode.classList.remove("active"));
          this.element
            .querySelectorAll("div.row-active")
            .forEach((pnode) => pnode.classList.remove("row-active"));
          this.element
            .querySelectorAll("a")
            .forEach(function(pnode) {
              pnode.classList.remove("node-selected");
